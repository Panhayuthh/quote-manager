export default function EmptyFolderSvg() {
    return (
        <svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="600" height="548" viewBox="0 0 600 548" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M546.773 389C503.303 482.878 408.257 548 298.002 548C187.746 548 92.7005 482.878 49.2305 389H546.773Z" fill="url(#paint5_linear_411_1557)"/>
        ...
        <linearGradient id="paint3_linear_411_1557" x1="48.0415" y1="462.105" x2="110.122" y2="307.716" gradientUnits="userSpaceOnUse">
        <stop stop-color="#111928"/>
        <stop offset="1" stop-color="#111928" stop-opacity="0"/>
        </linearGradient>
        <linearGradient id="paint4_linear_411_1557" x1="91.4443" y1="519.045" x2="237.827" y2="292.756" gradientUnits="userSpaceOnUse">
        <stop stop-color="#111928"/>
        <stop offset="1" stop-color="#111928" stop-opacity="0"/>
        </linearGradient>
