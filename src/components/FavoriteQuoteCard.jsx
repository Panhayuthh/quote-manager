...
export default function FavoriteQuoteCard() {
    ...
    return (
        ...
        {favoriteQuotes.map((favoriteQuote) => (
            <div key={favoriteQuote.id} className="bg-white rounded-lg shadow-lg p-6 m-6 border-b border-gray-200">
                ...
                <div className="mt-4 text-right">
                    <button
                        ...
                        className="bg-red-400 hover:bg-red-600 text-white font-bold p-2 rounded-lg 
